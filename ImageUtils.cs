...
namespace PA.PersianUtils.ImageUtils
{
    public static class Imaging
    {
        ...
        public static BitmapImage ConvertBitmapToBitmapImage(System.Drawing.Image source)
        {
        ...
        public static System.Windows.Media.Color ConvertDrawingColorToMediaColor(Color color)
        {
            return System.Windows.Media.Color.FromArgb(color.A, color.R, color.G, color.B);
        }

        public static Color ConvertMediaColorToDrawingColor(System.Windows.Media.Color color)
        {
            return Color.FromArgb(color.A, color.R, color.G, color.B);
        }

        public static Image ConvertBitmapImageToBitmap(BitmapSource bitmapSource)
        {
